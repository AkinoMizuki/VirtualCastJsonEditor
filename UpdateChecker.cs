...
{/*=== 更新チェッカー  ===*/
        ...
        {/*=== インポート開始 ===*/
            ...
            try
            {
                ...
                {/*=== 設定ファイルが無い ===*/
                    ...
                    Console.WriteLine("Error : \"" + UrlAddress + ConfFile + "\" could not be found.");
            ...
            {
                Console.WriteLine("Error : Failed to import \"" + UrlAddress + ConfFile + "\"."
                    + Environment.NewLine
    ...
    {/*=== 更新チェッカー ===*/
        ...
        *   アップデートチェック
        *********************************************************************/
        public bool UpdateCheck(string UpdateUrl)
        {/*=== アップデートチェック ===*/

            /*=== エラーログ定義 ===*/
            var LogFolde = System.Environment.GetFolderPath(Environment.SpecialFolder.Personal) + @"\My Games\VirtualCast\VCJE_UpdateCheckLog\";
            ...
            /*=== ソフトの現状確認 ===*/
            var version = ExeAsmCheck(UpdateUrl);
            logger.log("");
